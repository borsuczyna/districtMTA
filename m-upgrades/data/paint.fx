...
PSInput VertexShaderFunction(VSInput VS)
{
    ...
    float4 Specular = MTACalculateSpecular( gCameraDirection, gLight1Direction, PS.Normal, 20 ) * 0.2;
    ...
    PS.Diffuse.rgb = ((VehicleDiffuse + VehicleDynamicDiffuse) * Lighting) * gVehicleColor + Specular;
